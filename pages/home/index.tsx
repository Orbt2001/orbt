			...
			<div className={style.main}>
				...
				<div className={style.sobre}>
					<div className={style.corpotxt}>
						<p>
							...
							aplicativos com um design simples, bonito e que
							retrate a empresa e ao mesmo tempo um site completo,
							rápido e responsivo, com o SEO configurado e tudo
							mais que você possa ter direito. Trabalhamos para
							optimizar e melhorar a experiência da empresa com as
							novidades, sempre buscamos inovar e sempre manter
							nossos projetos atualizados e com ótima
							funcionalidade e velocidade. Além disso sempre
							buscamos ouvir nossos clientes e trabalhar em
							conjunto para que o site fique com a cara da empresa
							e que os clientes de tal tenham um experiência
							fantástica.
						</p>
					</div>
				</div>
				...
				<div className={style.gridw}>
					...
					<div className={style.text1}>
						<h3>Indesfer</h3>
						<p>
							É uma empresa regional que trabalha com corte e
							dobra de chapas, é nosso cliente a mais de 1 ano e
							tem ótimos resultado.
						</p>
					</div>
